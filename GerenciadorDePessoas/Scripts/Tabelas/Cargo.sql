...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."PK_CARGO" ON "SYSTEM"."CARGO" ("ID") 
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CARGO" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CARGO" MODIFY ("NOME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CARGO" ADD CONSTRAINT "PK_CARGO" PRIMARY KEY ("ID")
